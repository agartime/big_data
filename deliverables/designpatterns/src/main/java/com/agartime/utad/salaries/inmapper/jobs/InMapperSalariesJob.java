...
import com.agartime.utad.salaries.inmapper.mappers.SalaryRangeDistributorMapper;
import com.agartime.utad.salaries.inmapper.reducers.CounterReducer;
 ...
 */
public class InMapperSalariesJob extends Configured implements Tool{
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJobName("Gets Salaries Distribution using In Mapper Combining.");
        job.setJarByClass(InMapperSalariesJob.class);
        ...
        job.setMapperClass(SalaryRangeDistributorMapper.class);
    ...
    public static void main(String args[]) throws Exception {
        ToolRunner.run(new InMapperSalariesJob(), args);
    }
}
