...
#AGA: Se ve que las variables más correladas son Petal.Width y Petal.Lenght.
# En la gráfica, se ve qué variables se correlan siguiendo la X e Y en el 
# gráfico general eg. Seleccionar un gráfico, y buscar arriba abajo el título
# eg. Sepal. Lenght, Igual con izquierda derecha (e.g. Petal Length)
